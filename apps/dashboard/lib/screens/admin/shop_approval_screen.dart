...
import 'package:wonwon_dashboard/screens/unapproved_shop_detail_screen.dart';
import 'package:wonwon_dashboard/localization/app_localizations_wrapper.dart';
import 'package:wonwon_dashboard/widgets/optimized_image.dart';
            ...
            child: InkWell(
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => UnapprovedShopDetailScreen(shop: shop),
                  ),
                );
              },
              borderRadius: BorderRadius.circular(16),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                () {
                                  final allSubs = shop.subServices.values
                                      .expand((subs) => subs)
                                      .toList();
                                  if (allSubs.isEmpty) {
                                    return 'no_subservices'.tr(context);
                                  }
                                  final preview = allSubs.take(3).join(', ');
                                  return allSubs.length > 3
                                      ? '$preview...'
                                      : preview;
                                }(),
                                style: GoogleFonts.montserrat(
