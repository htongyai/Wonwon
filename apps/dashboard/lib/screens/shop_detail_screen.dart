...
import 'package:wonwon_dashboard/screens/edit_shop_screen.dart';
import 'package:wonwon_dashboard/screens/login_screen.dart';
import 'package:wonwon_dashboard/screens/report_form_screen.dart';
...
import 'package:wonwon_dashboard/widgets/info_row.dart';
import 'package:wonwon_dashboard/screens/log_repair_screen.dart';
...
import 'package:wonwon_dashboard/mixins/widget_disposal_mixin.dart';
...
import 'package:wonwon_dashboard/widgets/admin/analytics/shop_analytics_section.dart';
...
class _ShopDetailScreenState extends State<ShopDetailScreen>
  ...
  Future<void> _fetchShop() async {
    ...
    final shop = RepairShop.fromMap(data..['id'] = doc.id);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (_isAdmin) ShopAnalyticsSection(shopId: widget.shopId),
                if (_isAdmin) SizedBox(height: ResponsiveSize.getHeight(6)),
                _buildAddress(),
                SizedBox(height: ResponsiveSize.getHeight(6)),
              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  margin: EdgeInsets.only(
                    right: index < shop.photos.length - 1 ? 8 : 0,
                  ),
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(8),
                    child: getCachedImage(
