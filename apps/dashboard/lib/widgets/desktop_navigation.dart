...
import 'package:shared/utils/icon_helper.dart';
import 'package:wonwon_dashboard/screens/login_screen.dart';
import 'package:wonwon_dashboard/widgets/notification_icon.dart';
  ...
  void _openFeedback() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('send_feedback'.tr(context)),
        content: Text('feedback_coming_soon'.tr(context)),
        actions: [
          TextButton(
