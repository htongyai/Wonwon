...
import 'package:shared/services/firebase_shop_service.dart';
import 'package:shared/services/shop_cache_service.dart';
...
class ShopService {
  ...
  Future<List<RepairShop>> getUnapprovedShops() async {
    try {
      ...
      final QuerySnapshot snapshot =
          await shopsCollection.where('approved', isEqualTo: false).limit(100).get();
