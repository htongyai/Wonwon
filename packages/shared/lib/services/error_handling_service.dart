...
class ErrorHandlingService {
  ...
  static Future<bool> _checkConnectivity() async {
    // Basic connectivity assumption - returns true as a fallback.
    // For more robust checks, integrate the connectivity_plus package.
    return true;
  }
  ...
  static Future<void> _clearAuthData() async {
    try {
      ...
      appLog('Error clearing auth data: $e');
    }
  }

  static void _navigateToLogin(BuildContext context) {
    // Pop all routes back to the root (auth gate handles login redirect)
