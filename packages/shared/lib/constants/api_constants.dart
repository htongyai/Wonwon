...
class ApiConstants {
  ...
  static final bool enableDebugLogging = !kReleaseMode;
  static final bool enableVerboseLogging = false;
  static final bool enableNetworkLogging = !kReleaseMode;
  static final bool enablePerformanceLogging = !kReleaseMode;

  // Production Configuration
  static final bool productionMode = kReleaseMode;
  ...
  // Note: API keys should be stored in environment variables or secure configuration
